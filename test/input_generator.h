...
vector<int> get_random_values(
    int total, 
    pair<int,int> val_range=VALUES_RANGE
);
vector<int> get_random_duplicate_values(
    int total, 
    pair<int,int> val_range=VALUES_RANGE, 
    pair<int,int> duplication_range=SMALL_POSITIVE_VALUES_RANGE
);

vector<int> get_partially_sorted_values(
    int total,
    pair<int,int> val_range=VALUES_RANGE
);
...
vector<vector<int>> get_random_duplicate_set(int total, pair<int,int> n_range, pair<int,int> val_range, pair<int,int> duplication_range);
